...
data_folder = Path("/media/tim/Seagate Hub/transfer_study_opensmile_files/")
...
final_df.to_csv(os.path.join(ROOT_DIR, "data/out/opensmile_data_external.csv"), index=False)
