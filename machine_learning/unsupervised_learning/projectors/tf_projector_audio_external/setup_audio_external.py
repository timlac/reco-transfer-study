import os.path
import pandas as pd
from constants import openface_feature_columns, ROOT_DIR, opensmile_feature_columns
...
openface_path = os.path.join(ROOT_DIR, "data/out/opensmile_data_external.csv")
...
vec = df[opensmile_feature_columns].values
